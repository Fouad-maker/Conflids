...
export class HeaderComponent implements OnInit {
  ...
  lc : LigneCommande = {mat: "",qteArtLC :0, article: {mat:"",designtationArt:"",imageName:"",descriptionArt:"",prixArt:0,qteStockArt:0,tauxRemiseArt:0,marqueArt:{mat:"",libelleMarq:""}
  ,sousCategorieArt:{mat:"",libelleSousCat:""},fournisseurArt:{}}};
  constructor(private router : Router ,private authService : AuthenticationServiceService ,private http:HttpClient,public serviceClient : ServiceClientService
  ...
  getUserByUsername(){
    ...
    return this.http.get(this.host2+"/appUsers/"+this.usernameAuth).subscribe(data =>{
